                  ...
                  <button
                    ...
                    className={
                      chartToDisplay == tab.type
                        ...
                        : "inline-block p-4 border-b-2 border-transparent rounded-t-lg text-slate-800 dark:text-slate-50 hover:text-gray-700 hover:border-gray-700 dark:hover:border-gray-100 dark:hover:text-gray-100"
                    }
                  >
                    {tab.title}
                  </button>
